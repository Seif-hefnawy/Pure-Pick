...
const footerSections = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Cookie Policy", href: "/shipping" },
...
export default function Footer() {
  return (
    <footer className="w-full bg-[#0a0a0a] pt-10 pb-6 mt-5 border-t border-white/5">
      <div className="container mx-auto px-6 md:px-12">
        {/* الجزء العلوي: المميزات (الأيقونات الأربعة) */}
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8  pb-12 border-b border-white/5">
          {[
            {
              icon: Truck,
              title: "Free Shipping",
            ...
            <div key={i} className="flex items-center gap-4 group">
              ...
              <div>
                <h5 className="text-on-surface font-bold text-sm">
                  {item.title}
                </h5>
